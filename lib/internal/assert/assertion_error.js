...
const { patienceDiff } = require('internal/assert/patience_diff/patience_diff');
const { printPatienceDiff, printSimplePatienceDiff } = require('internal/assert/patience_diff/utils');
...
function createErrDiff(actual, expected, operator, customMessage) {
  ...
  if (showSimpleDiff) {
    ...
    const myersDiffMessage = printPatienceDiff(diff);
